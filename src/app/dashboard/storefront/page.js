  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute bottom-1 right-1 w-6 h-6 rounded-full bg-black/70 text-white flex items-center justify-center shadow-md hover:bg-black/85 transition-colors"
      >
