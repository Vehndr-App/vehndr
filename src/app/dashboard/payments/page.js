    ...
    <div className="min-h-screen bg-[var(--background)] pb-24">
      ...
      <div className="px-4 py-6">
        <div className="max-w-lg mx-auto space-y-6">
          {/* Status Card */}
          <div className={`card p-5 ${isConnected ? 'bg-[var(--success)]/5 border border-[var(--success)]/20' : 'bg-[var(--warning)]/5 border border-[var(--warning)]/20'}`}>
          ...
          <div className="card bg-white p-5">
            ...
            <div className="space-y-4">
              <Step number={1} title="Connect Your Account" description="Link your Stripe account to receive payments" />
              <Step number={2} title="Accept Payments" description="Customers pay securely through our checkout" />
          ...
          <div className="card bg-[var(--gray-50)] p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-[var(--gray-700)]">Transaction Fees</p>
                <p className="text-sm text-[var(--gray-500)] mt-1">
                  A platform fee is automatically deducted from each transaction. You&apos;ll see your net earnings in the Transactions section.
                </p>
              </div>
            </div>
          </div>
